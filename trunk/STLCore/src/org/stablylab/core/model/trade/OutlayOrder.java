 ...
 *		objectid-class="org.stablylab.core.model.trade.id.OutlayOrderID"
 *		detachable="true"
 *		table="STL_OutlayOrder"
 *
 * @jdo.version strategy="version-number"
 *
 * @jdo.inheritance strategy="new-table"
 *
 * @jdo.create-objectid-class field-order="organisationID, outlayOrderID"
 */
public class OutlayOrder implements Serializable {
	...
	public static long createOutlayOrderID()
	{
		return IDGenerator.nextID(OutlayOrder.class);
	}
	 ...
	 *		element-type="org.stablylab.core.model.trade.OutlayOrderItem"
	 *		dependent-element="true"
	 * 		default-fetch-group="true"
	 */
	private Set<OutlayOrderItem> items;
	...
	public Set<OutlayOrderItem> getItems() {
		return items;
	}

	public void setItems(Set<OutlayOrderItem> items) {
		this.items = items;
	}
}
