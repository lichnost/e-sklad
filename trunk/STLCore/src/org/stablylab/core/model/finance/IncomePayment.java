 ...
 *		objectid-class="org.stablylab.core.model.finance.id.IncomePaymentID"
 *		detachable="true"
 *		table="STL_IncomePayment"
 *
 * @jdo.version strategy="version-number"
 *
 * @jdo.inheritance strategy="new-table"
 *
 * @jdo.create-objectid-class field-order="organisationID, incomePaymentID"
 */
public class IncomePayment implements Serializable
{
	...
	public static long createIncomePaymentID()
	{
		return IDGenerator.nextID(IncomePayment.class);
	}
